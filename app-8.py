...
def admin_receipt_tag_keyboard():
    return [[{"text": "🟢 پرداخت کردم", "callback_data": "noop"}]]
...
def telegram_webhook():
    ...
    if "callback_query" in update:
        ...
        if data == "menu":
            ...
            pass  # دکمه تزئینی روی پیام ادمین، کاری انجام نمی‌ده
            ...
            if not receipt_message_id:
                ...
                tg_send(
                    ...
                    f"برای ارسال فایل سرور:\n/sendfile {chat_id}\n\n"
                    f"یا برای پیام متنی:\n/send {chat_id} <پیام>",
                    keyboard=admin_receipt_tag_keyboard(),
                )
